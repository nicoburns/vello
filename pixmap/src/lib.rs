...
//!
//! This crate provides [`Pixmap`], a container of premultiplied RGBA8 pixels, along with
//! [`PixmapMut`], a mutable view into such data. It is used by the Vello renderers as a
//! simple CPU-side image buffer.
//!
//! # Features
//!
...
//! - `png` (enabled by default): Allow loading [`Pixmap`]s from PNG images and encoding
//!   them back to PNG. Implies `std`.
//!
